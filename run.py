...
def prepare_rawdata_our(path_config):
...
def prepare_rawdata_nicu(path_config):
...
def prepare_dataset_our(path_config, ch_max, block_ch, is_custom, name_ch):
...
def prepare_dataset_nicu(path_config, ch_max, block_ch, is_custom, name_ch):
...
if __name__ == "__main__":
    ...
    #prepare_rawdata_our(path_config)
    #prepare_rawdata_nicu(path_config)
    
    prepare_dataset_our(path_config, ch_max, block_ch, is_custom, name_ch)
    #prepare_dataset_nicu(path_config, ch_max, block_ch, is_custom, name_ch)
