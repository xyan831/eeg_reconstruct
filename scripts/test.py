...
def run_mat1(path_list, name, listname, ch_max, block_ch, data_type, is_custom):
    # get folder paths
...
def run_mat2(path_list, name, listname, ch_max, block_ch, data_type, is_custom):
    # get folder paths
    mat_path, data_path = path_list
    if listname=="our":
...
if __name__ == "__main__":
    ...
    #run_mat1(path_list, train_data, dataset, ch_max, block_ch, data_type, is_custom)
    #run_mat2(path_list, train_data, dataset, ch_max, block_ch, data_type, is_custom)
    ...
    #run_recon(path_list, "test", train_data, recon_model, recon_type, epoch_num, data_type, isFFT, savebest, sample)
